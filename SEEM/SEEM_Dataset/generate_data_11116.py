    ...
    for idx in range(len(curr_seq)):
        for i in range(len(curr_seq[idx])):
            if idx == 0:
                ...
                plt.scatter(curr_seq[idx][i][0][9:], curr_seq[idx][i][1][9:], c='#808080', marker='o')
            elif idx == 1:
                plt.scatter(curr_seq[idx][i][0][9:], curr_seq[idx][i][1][9:], c='g', marker='o')
            elif idx == 2:
                plt.scatter(curr_seq[idx][i][0][9:], curr_seq[idx][i][1][9:], c='b', marker='o')
            elif idx == 3:
                plt.scatter(curr_seq[idx][i][0][9:], curr_seq[idx][i][1][9:], c='y', marker='o')
            elif idx == 4:
